...
<body>
      ...
      <div class="logo mr-auto" id="tt">
        <h1  ><a href="index.php">Credit System</a></h1>
        </div>

  <!-- ======= Header ======= -->
 
   <nav class="navbar navbar-expand-lg navbar-light bg-light" id ="vv">
  <a class="navbar-brand" href="#">Navbar</a>
  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation" id ="cc">
...
<div id="mydiv">
      <select class ="semester" id="semester" onchange="fun_Show()" style="width: 120px;float: right;">
