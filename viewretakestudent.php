        ...
        <ul>
          ...
          <li class="drop-down"><a href="#">Student</a>
            <ul>
              ...
              <li class="active"><a href="viewretakestudent.php">View Retake Student</a></li>
        ...
        <div class="row justify-content-end">
          <div class="col-lg-11">
            <div class="row justify-content-end">
              ...
              <div class="container">
                   <div class="panel">
                    <center><div class="panel-body"  style="height: 120px; background-color: #e9ecef; padding-top: 30px"><h1> View Retake Student</h1></div></center>

                  </div>
    
                <div class="navbar navbar-light bg-light float-right"> 
                  
                 <select class="navbar-link btn btn-info">                
                ...
                <?php 
                    ...
                    $query="SELECT * FROM `retakestudent`";
                ...
                <tbody>
                  <tr>
                    ...
                    <td><?php echo $value['rno']; ?></td>
                    <td><?php echo $value['sid']; ?></td>
                    <td><?php echo $value['scode']; ?></td>
                    <td><?php echo $value['totalmark']; ?></td>
                    
                    <td><a href="editRetakemark.php?edit=<?php echo $value['rno']?>" class="btn btn-warning">Edit</a></td>
