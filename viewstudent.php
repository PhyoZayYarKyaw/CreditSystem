          ...
          <div class="col-lg-11">
            <div class="row justify-content-end">
                 <div class="container">
                  ...
                  <div class="panel">
                    <center><div class="panel-body"  style="height: 120px; background-color: #e9ecef; padding-top: 30px"><h1> View Student</h1></div></center>

                  </div>
    
                <div class="navbar navbar-light bg-light"> 
                  <a href="addstudent.php" class="btn btn-primary navbar-link">Add New Student</a>
                ...
                <tbody>
                  <tr>
                   ...
                   <!--  <td><?php echo $no++; ?></td> -->
                    ...
                    <td><?php echo $value['totalattempt']; ?></td>
                    
                    <td><a href="updatestudent.php?edit=<?php echo $value['sid']?>" class="btn btn-warning">Edit</a></td>



                    <td><button class="btn btn-secondary"><a class="deletestudent" href="viewstudent.php?delete=<?php echo $value['sid']?>">Delete</a></button></td>
                  </tr>
                </tbody>
                  <?php } ?>
                </table>
...
<?php 
  require_once 'db.php';
    ...
    if (isset($_GET['delete'])) {
      ...
      $sql="DELETE FROM student WHERE sid='$delete'";
