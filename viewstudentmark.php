          ...
          <li class="drop-down"><a href="#">Subject</a>
           ...
           <li class="drop-down"><a href="#">Mark</a>
            <ul>
              ...
              <li class="active"><a href="viewstudentmark.php">View Student Mark</a></li>
            </ul>
          </li>
        ...
        <div class="row justify-content-end">
          <div class="col-lg-11">
            <div class="row justify-content-end">
              ...
              <div class="container">
                 <div class="panel">
                    <center><div class="panel-body"  style="height: 120px; background-color: #e9ecef; padding-top: 30px"><h1> View Student Mark</h1></div></center>

                  </div>
    
                <div class="navbar navbar-light bg-light"> 
                  <a href="studentmark.php" class="btn btn-primary navbar-link">Add New Student Mark</a>
                ...
                <tbody>
                  <tr>
                    ...
                    <td><?php echo $value['written']; ?></td>
                    <td><?php echo $value['tutorial']; ?></td>
                    <td><?php echo $value['assignment']; ?></td>
                    <td><?php echo $value['quiz']; ?></td>
