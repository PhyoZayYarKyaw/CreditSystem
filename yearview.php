            ...
            <div class="row justify-content-end">
              ...
              <div class="container">
                ...
                <div class="navbar navbar-light bg-light"> 
                  ...
                  <a href="dt.php" class="previous" style="text-decoration: none;
                  display: inline-block;
                  padding: 8px 16px;
                  margin-right: 50px;height: 40px;">&laquo; View All Subjects</a>

                <form action="yearview.php" method="post">
                	<button name="submit" onclick="demoDisplay();" value="search" class="navbar-link btn btn-info float-right">Search</button>

          

					<select name="sel" class="navbar-link btn btn-info" style="height: 40px; margin-right: 30px;">
