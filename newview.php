              ...
              <div class="container">
                ...
                <div class="navbar navbar-light bg-light"> 
                  <a href="addsubject.php" class="btn btn-primary navbar-link">Add New Subject</a>
                   <select class="navbar-link btn btn-info float-right" name ="year" id="year" value="year">                
                     <option selected value="0">View All Subject</option>  
